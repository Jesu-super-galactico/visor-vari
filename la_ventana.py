    ...
    class La_mini:
        ...
        def sub_ventana(self):
            ...
            if True:    # visual y botones
                ...
                self.vidrio= tkinter.Tk()
                
                titulo= formando_nombre_de_ventana()
                self.vidrio.title(titulo)

                dereizq= tkinter.LabelFrame(self.vidrio, padx= 10, pady= 10, bd= 0)
                ...
                self.perimetro_1= tkinter.LabelFrame(dereizq, padx= 10, pady= 10, bg= "red")
                self.perimetro_1.pack (expand= True, fill= tkinter.BOTH)

                entorno= tkinter.LabelFrame(self.perimetro_1, padx= 30, pady= 30) # marco izquierdo (de texto)
